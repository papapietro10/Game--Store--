...
<p class="description">
<b>Descripcion: </b> <span>Hasta 120 fps con salida de 120 Hz : disfrute de un juego fluido y fluido con una alta velocidad de fotogramas de hasta 120 fps para juegos compatibles, con soporte para salida de 120 Hz en pantallas 4K.</span>
</p>
<p class="description">
<span>Tempest 3D AudioTech : sumérjase en paisajes sonoros donde se siente como si el sonido viniera de todas las direcciones. A través de sus auriculares o parlantes de TV, su entorno realmente cobra vida con Tempest 3D AudioTech en juegos compatibles.</span>
</p>
<div class="bottom">
...
button.innerText = "Aadir carrito"
}
}
singleButton(id){
